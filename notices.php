		...
		<div class="centerBox">
			<div class="sideBar">
				<ul class="sideNav">
					...
					<li><a href="notices.php?type=stdact">All Activities</a></li>
			...
			<div class = "mainContent">
				<?php 
					...
					if($type=="event"){
						...
						getResults("event","event","evnt_",2,"long","false");					
						echo "</ul>";
					}
					else if($type=="news"){
						echo "<h1>News listing of NIT Kurukshetra</h1>";
						echo "<ul class='noticeList'>";
							getResults("news","news","news_",2,"long","false");
						echo "</ul>";
					}
					else if($type=="notice"){
						echo "<h1>Notice listing of NIT Kurukshetra</h1>";
						echo "<ul class='noticeList'>";
						getResults("notice","notice","notice_",2,"long","false");
						echo "</ul>";
					}
					else if($type=="stdact"){
						echo "<h1>Student Activites of NIT Kurukshetra</h1>";
						echo "<ul class='noticeList'>";
						getResults("stdact","stdact","stdact_",2,"long","false");
						echo "</ul>";
					}
					else if($type=="tender"){
						echo "<h1>Tender listing of NIT Kurukshetra</h1>";
						echo "<ul class='noticeList'>";
						getResults("tender","tender","tndr_",2,"long","false");
						echo "</ul>";
					}
					else if($type=="interview"){
						echo "<h1>Vacancy listing of NIT Kurukshetra</h1>";
						echo "<ul class='noticeList'>";
						getResults("interview","walkin","wlk_",2,"long","false");	
						echo "</ul>";										
					}
					else if($type=="scrollnews"){
						echo "<h1>Scroll News listing of NIT Kurukshetra</h1>";
						echo "<ul class='noticeList'>";
						getResults("scrollnews","scrollnews","scroll_",2,"long","false");	
						echo "</ul>";										
					}
					else{
